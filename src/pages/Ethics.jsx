...
const Ethics = () => {
  ...
  const ethicsSections = [
    ...
    },
    {
      ...
      items: [
        "Law, Diplomacy, Tech and Public Policy Review was founded to counter unethical practices that exploit student researchers.",
    ...
    >
      ...
      >
        ...
        <p className="text-md max-w-3xl mx-auto text-accent-light">
          Our unwavering commitment to academic integrity, transparency, and student empowerment drives everything we do at Law, Diplomacy, Tech and Public Policy Review.
        </p>
      </motion.div>
